...
tags: ["api"]
---
[GitHub - mdsol/Medidata.ZipkinTracerModule](https://github.com/mdsol/Medidata.ZipkinTracerModule) is a "A .NET implementation of the Zipkin Tracer client."  I built a simple Web Api 2 service, similar to the code from the [Zipkin JS Investigation](../2016-07-11-zipkin-js-investigation).  The service recursively calls itself base on the count parameter:  (e.g., `http://localhost:52399/api/hello?count=3`).
